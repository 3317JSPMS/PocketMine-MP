...
class Item{
	...
	private static function initCreativeItems(){
		...
		self::addCreativeItem(Item::get(Item::BIRCH_DOOR, 2));
		self::addCreativeItem(Item::get(Item::JUNGLE_DOOR, 3));
		self::addCreativeItem(Item::get(Item::ACACIA_DOOR, 4));
		self::addCreativeItem(Item::get(Item::DARK_OAK_DOOR, 5));
		// TODO: Iron door
